          ...
          <Row className="px-xl-5">
            ...
            <Col lg="10" className="docs-content">
              <div className="docs-item">
                ...
                <div className="mt-5">
                  <p>
                    For version 2 of the Sell React theme, we've decided to
                    switch to the{" "}
              ...
              <div className="docs-item">
                ...
                <div className="mt-5">
                  ...
                  <p>
                    To show the changes needed to upgrade Sell [React] from v1
                    to v2, please look at a few examples below.
                  </p>
                </div>
              </div>
              <div className="docs-item">
