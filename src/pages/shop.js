              ...
              <div className="side-options">
                ...
                <div className="selected-city-card">
                  {selectedCities.map((city) => (
                    <h6 key={city}>
                      {city} <svg className="x-close" onClick={() => handleCitySelection(city)} width="12" height="12" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="women-collection-three">
              ...
              <div className="women-collection">
                ...
                <div class="card-group hypso-women-card">
                  <Col xl="4" md="6" sm="6" className="w-48-p" >
